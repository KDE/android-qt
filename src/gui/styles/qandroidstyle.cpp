...
static const char * const qt_android_slider_verticalhandle[] = {
    "15 11 6 1",
    "   c None",
    "+  c #979797",
    "@  c #C9C9C9",
...
static const char * const qt_android_slider_verticalhandle_left[] = {
    "15 11 6 1",
    "   c None",
    "+  c #979797",
    "@  c #C9C9C9",
...
static const char * const qt_android_slider_horizontalhandle[] = {
    "11 15 6 1",
    "   c None",
    "+  c #979797",
    "@  c #C9C9C9",
...
static const char * const qt_android_slider_horizontalhandle_up[] = {
    "11 15 6 1",
    "   c None",
    "+  c #979797",
    "@  c #C9C9C9",
...
static void qBrushSetAlphaF(QBrush *brush, qreal alpha)
{
    if (const QGradient *gradient = brush->gradient()) {
        ...
        default:
            qWarning("QAndroidStyle::qBrushLight() - unknown gradient type"
...
static QBrush qBrushDark(QBrush brush, int dark)
{
    if (const QGradient *gradient = brush.gradient()) {
        ...
        default:
            qWarning("QAndroidStyle::qBrushDark() - unknown gradient type"
                     " - falling back to QLinearGradient");
        case QGradient::LinearGradient: {
            QLinearGradient grad = *static_cast<const QLinearGradient *>(gradient);
            grad.setStops(stops);
...
/*
    ...
    01        10
     0111111110
*/
static void qt_android_draw_frame(QPainter *painter, const QRect &rect, const QStyleOption *option,
...
static void qt_android_draw_gradient(QPainter *painter, const QRect &rect, const QColor &gradientStart,
                                       const QColor &gradientStop)
{
    QString gradientName = QLatin1Literal("qandroid-g")
...
static void qt_android_drawFrame(QPainter *painter, const QStyleOption *option, const QWidget *widget)
{
...
static void qt_android_drawShadedPanel(QPainter *painter, const QStyleOption *option, bool base,
                                         const QWidget *widget)
{
    ...
    if ((option->state & QStyle::State_Enabled) || !(option->state & QStyle::State_AutoRaise)) {
        if ((option->state & QStyle::State_Sunken) || (option->state & QStyle::State_On)) {
            qt_android_draw_gradient(painter, rect.adjusted(1, 1, -1, -1),
    ...
    qt_android_drawFrame(painter, option, widget);

    painter->setPen(oldPen);
}

static void qt_android_draw_mdibutton(QPainter *painter, const QStyleOptionTitleBar *option, const QRect &tmp, bool hover, bool sunken)
{
    if (tmp.isNull())
        return;
    ...
    qt_android_draw_gradient(painter, tmp.adjusted(1, 1, -1, -1),
...
static void qt_android_draw_handle(QPainter *painter, const QStyleOption *option,
...
class QAndroidStylePrivate : public QWindowsStylePrivate
{
    Q_DECLARE_PUBLIC(QAndroidStyle)
public:
    QAndroidStylePrivate();
    virtual ~QAndroidStylePrivate();
...
/*!
  \internal
 */
QAndroidStylePrivate::QAndroidStylePrivate() :
...
/*!
    \class QAndroidStyle
    \brief The QAndroidStyle class provides a widget style similar to the
    Plastik style available in KDE.

    The Android style provides a default look and feel for widgets on X11
    that closely resembles the Plastik style, introduced by Sandro Giessl in
    KDE 3.2.

    \img qandroidstyle.png
    \sa QWindowsXPStyle, QMacStyle, QWindowsStyle, QCDEStyle, QMotifStyle
*/

/*!
    Constructs a QAndroidStyle object.
*/
QAndroidStyle::QAndroidStyle()
    : QWindowsStyle(*new QAndroidStylePrivate)
{
    setObjectName(QLatin1String("Android"));
}

/*!
    Destructs the QAndroidStyle object.
*/
QAndroidStyle::~QAndroidStyle()
{
}
...
*/
void QAndroidStylePrivate::drawPartialFrame(QPainter *painter, const QStyleOptionComplex *option,
                                              const QRect &rect, const QWidget *widget) const
{
    Q_Q(const QAndroidStyle);
...
/*!
  \reimp
*/
void QAndroidStyle::drawPrimitive(PrimitiveElement element, const QStyleOption *option,
                                    QPainter *painter, const QWidget *widget) const
{
    ...
    case PE_Frame: {
        ...
        qt_android_draw_frame(painter, option->rect, option, shadow);
        break;
    }
#ifndef QT_NO_LINEEDIT
    ...
    case PE_PanelButtonTool:
        ...
        if ((option->state & State_Enabled || option->state & State_On) || !(option->state & State_AutoRaise))
            qt_android_drawShadedPanel(painter, option, true, widget);
        break;
    ...
    case PE_PanelButtonCommand:
        if (const QStyleOptionButton *button = qstyleoption_cast<const QStyleOptionButton *>(option)) {
            ...
            // Draw border
            qt_android_draw_frame(p, rect, option);
    ...
    case PE_IndicatorDockWidgetResizeHandle:
        ...
        if (option->state & State_Horizontal) {
            ...
            qt_android_draw_handle(painter, option, rect, Qt::Vertical, widget);
        } else {
            int height = option->rect.height() / 3;
            QRect rect(option->rect.left() + (option->rect.width() / 2 - 1),
                       option->rect.center().y() - height / 2, 3, height);
            qt_android_draw_handle(painter, option, rect, Qt::Horizontal, widget);
        }
        break;
    ...
    case PE_IndicatorBranch: {
        ...
        if (option->state & State_Children) {
            ...
            if (option->palette.base().style() == Qt::SolidPattern) {
                ...
                qt_android_draw_gradient(painter, gradientRect, baseGradientStartColor, baseGradientStopColor);
            } else {
...
/*!
  \reimp
*/
void QAndroidStyle::drawControl(ControlElement element, const QStyleOption *option,
                                  QPainter *painter, const QWidget *widget) const
{
    QColor borderColor = option->palette.background().color().darker(178);
    QColor alphaCornerColor;
    ...
    case CE_HeaderSection:
        ...
        if (const QStyleOptionHeader *header = qstyleoption_cast<const QStyleOptionHeader *>(option)) {
            ...
            if (!QPixmapCache::find(pixmapName, cache)) {
                ...
                qt_android_draw_gradient(&cachePainter, pixmapRect,
    ...
    case CE_MenuItem:
        ...
        if (const QStyleOptionMenuItem *menuItem = qstyleoption_cast<const QStyleOptionMenuItem *>(option)) {
            ...
            if (selected) {
                qt_android_draw_gradient(painter, menuItem->rect,
            ...
            if (checkable) {
                if ((menuItem->checkType & QStyleOptionMenuItem::Exclusive) && menuItem->icon.isNull()) {
                    ...
                    if (menuItem->icon.isNull()) {
                        ...
                        opt.rect = sunkenRect;
                        qt_android_drawShadedPanel(painter, &opt, false, widget);
                    }
                }
            }
    ...
    case CE_MenuBarItem:
        ...
        if ((option->state & State_Selected)) {
            ...
            if (!QPixmapCache::find(pixmapName, cache)) {
                ...
                // gradient fill
                if ((option->state & QStyle::State_Sunken) || (option->state & QStyle::State_On)) {
                    qt_android_draw_gradient(&cachePainter, rect.adjusted(1, 1, -1, -1),
                                               option->palette.button().color().darker(114),
                                               option->palette.button().color().darker(106));
                } else {
                    qt_android_draw_gradient(&cachePainter, rect.adjusted(1, 1, -1, -1),
            ...
            if (!QPixmapCache::find(subLinePixmapName, cache)) {
                ...
                if (isEnabled) {
                    ...
                    if ((scrollBar->activeSubControls & SC_ScrollBarSubLine) && sunken) {
                        qt_android_draw_gradient(&subLinePainter,
    ...
    case CE_ComboBoxLabel:
        if (const QStyleOptionComboBox *comboBox = qstyleoption_cast<const QStyleOptionComboBox *>(option)) {
            ...
            if (!comboBox->editable) {
                // Android's non-editable combo box is drawn as a button, so
...
/*!
  \reimp
*/
void QAndroidStyle::drawComplexControl(ComplexControl control, const QStyleOptionComplex *option,
                                         QPainter *painter, const QWidget *widget) const
{
    QColor borderColor = option->palette.background().color().darker(178);
    QColor alphaCornerColor;
        ...
        if (const QStyleOptionSlider *slider = qstyleoption_cast<const QStyleOptionSlider *>(option)) {
            ...
            if ((option->subControls & SC_SliderHandle) && handle.isValid()) {
                ...
                if (!QPixmapCache::find(handlePixmapName, cache)) {
                    ...
                    QImage image;
                    if (horizontal) {
                        image = QImage((ticksAbove && !ticksBelow) ? qt_android_slider_horizontalhandle_up : qt_android_slider_horizontalhandle);
                    } else {
                        image = QImage((ticksAbove && !ticksBelow) ? qt_android_slider_verticalhandle_left : qt_android_slider_verticalhandle);
                    }
    ...
    case CC_TitleBar:
        if (const QStyleOptionTitleBar *titleBar = qstyleoption_cast<const QStyleOptionTitleBar *>(option)) {
...

            {
                ...
                qt_android_draw_gradient(painter, option->rect.adjusted(1, 1, -1, 0),
            ...
            if ((titleBar->subControls & SC_TitleBarMinButton)
                ...
                qt_android_draw_mdibutton(painter, titleBar, minButtonRect, hover, sunken);
            ...
            if ((titleBar->subControls & SC_TitleBarMaxButton)
                ...
                qt_android_draw_mdibutton(painter, titleBar, maxButtonRect, hover, sunken);
            ...
            if (titleBar->subControls & SC_TitleBarCloseButton && titleBar->titleBarFlags & Qt::WindowSystemMenuHint) {
                ...
                qt_android_draw_mdibutton(painter, titleBar, closeButtonRect, hover, sunken);
            ...
            if ((titleBar->subControls & SC_TitleBarNormalButton) &&
                ...
                qt_android_draw_mdibutton(painter, titleBar, normalButtonRect, hover, sunken);
            ...
            if (titleBar->subControls & SC_TitleBarContextHelpButton
                ...
                qt_android_draw_mdibutton(painter, titleBar, contextHelpButtonRect, hover, sunken);
            ...
            if (titleBar->subControls & SC_TitleBarShadeButton) {
                ...
                qt_android_draw_mdibutton(painter, titleBar, shadeButtonRect, hover, sunken);
            ...
            if (titleBar->subControls & SC_TitleBarUnshadeButton) {
                ...
                qt_android_draw_mdibutton(painter, titleBar, unshadeButtonRect, hover, sunken);
            ...
            if ((titleBar->subControls & SC_TitleBarSysMenu) && (titleBar->titleBarFlags & Qt::WindowSystemMenuHint)) {
                ...
                if (hover)
                    qt_android_draw_mdibutton(painter, titleBar, iconRect, hover, sunken);
...
/*!
  \reimp
*/
QSize QAndroidStyle::sizeFromContents(ContentsType type, const QStyleOption *option,
...
/*!
  \reimp
*/
QRect QAndroidStyle::subElementRect(SubElement element, const QStyleOption *option, const QWidget *widget) const
{
    QRect rect;
    switch (element) {
...
/*!
  \reimp
*/
QRect QAndroidStyle::subControlRect(ComplexControl control, const QStyleOptionComplex *option,
...
/*!
  \reimp
*/
int QAndroidStyle::styleHint(StyleHint hint, const QStyleOption *option, const QWidget *widget,
...
/*!
  \reimp
*/
QStyle::SubControl QAndroidStyle::hitTestComplexControl(ComplexControl control, const QStyleOptionComplex *option,
...
/*!
  \reimp
*/
int QAndroidStyle::pixelMetric(PixelMetric metric, const QStyleOption *option, const QWidget *widget) const
{
    int ret = -1;
    switch (metric) {
    case PM_MenuVMargin:
...
#if defined QAndroid_MaskButtons
...
/*!
  \reimp
*/
void QAndroidStyle::polish(QApplication *app)
{
...
/*!
  \reimp
*/
void QAndroidStyle::polish(QPalette &pal)
{
...
/*!
  \reimp
*/
void QAndroidStyle::unpolish(QApplication *app)
{
...
/*!
    \internal
*/
QIcon QAndroidStyle::standardIconImplementation(StandardPixmap standardIcon, const QStyleOption *option,
...
/*!
    \internal
*/
int QAndroidStyle::layoutSpacingImplementation(QSizePolicy::ControlType control1,
...
/*!
    \reimp
*/
bool QAndroidStyle::eventFilter(QObject *watched, QEvent *event)
{
#ifndef QT_NO_PROGRESSBAR
    Q_D(QAndroidStyle);
...
/*!
    \reimp
*/
void QAndroidStyle::timerEvent(QTimerEvent *event)
{
#ifndef QT_NO_PROGRESSBAR
    Q_D(QAndroidStyle);
