...
{
public:
    virtual QString fontDir() const {       return QLatin1String("/system/fonts"); }
...
QPlatformWindow *QAndroidEglFSIntegration::createPlatformWindow(QWidget *widget, WId winId) const
{
    ...
    QAndroidEglFSWindow* result = new QAndroidEglFSWindow(widget, m_primaryScreen);
...
QWindowSurface *QAndroidEglFSIntegration::createWindowSurface(QWidget *widget, WId winId) const
{
    ...
    QAndroidEglFSWindowSurface* result = new QAndroidEglFSWindowSurface(m_primaryScreen,widget);
